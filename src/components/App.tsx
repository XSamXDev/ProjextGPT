...
function BackgroundCanvas() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      ctx.fillStyle = g1;
      ctx.beginPath();
      ctx.arc(cx1, cy1, 320, 0, Math.PI * 2);
      ctx.fill();
      ...
      ctx.fillStyle = g2;
      ctx.beginPath();
      ctx.arc(cx2, cy2, 260, 0, Math.PI * 2);
      ctx.fill();
    ...
    >
      ...
      <nav
        ...
        style={{
          ...
          borderRadius: 0,
          boxShadow:
            "0 2px 40px rgba(0,0,0,0.7), 0 1px 0 rgba(0,212,255,0.1), inset 0 1px 0 rgba(255,255,255,0.04)",
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <div
            style={{
              ...
              background:
                "linear-gradient(90deg, #00d4ff 0%, #a78bfa 50%, #00ff9d 100%)",
          ...
          >
            <span
              style={{
                ...
                boxShadow:
                  modelStatus === "ready"
                    ? `0 0 8px ${meta.color}, 0 0 16px ${meta.color}`
                    : "none",
          ...
          {showModelPanel && (
            <div
              style={{
                ...
                boxShadow:
                  "0 16px 60px rgba(0,0,0,0.8), 0 0 30px rgba(0,212,255,0.06)",
              }}
            >
              <div
                style={{
              ...
              {[
                ...
                {
                  label: "Cached",
                  value: isCached ? "✓ Yes" : "✗ No",
                  color: isCached ? "#00ff9d" : "#ff2d78",
                },
                ...
                >
                  <span style={{ color: "#6a9ab8", fontWeight: 500 }}>
                    {label}
                  </span>
                  <span
                    style={{
      ...
      >
        ...
        >
              ...
              {isProcessing && (
                <button
                  ...
                  style={{
                    ...
                    color: isCancelling ? "rgba(255,45,120,0.4)" : "#ff2d78",
          ...
          >
            ...
            {ACTION_CONFIG.map(({ id, label, color }) => (
              <button
                ...
                style={{
                  ...
                  color: ready && !isProcessing ? color : undefined,
                }}
                onMouseEnter={(e) => {
                  if (ready && !isProcessing)
                    (e.currentTarget as HTMLButtonElement).style.boxShadow =
                      `0 0 18px ${color}30, inset 0 0 18px ${color}08`;
                }}
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLButtonElement).style.boxShadow = "";
                }}
            ...
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(0,255,157,0.1), rgba(0,212,255,0.05))",
                borderColor: "rgba(0,255,157,0.3)",
                color: ready && !isProcessing ? "#00ff9d" : undefined,
                boxShadow:
                  ready && !isProcessing
                    ? "0 0 15px rgba(0,255,157,0.12)"
                    : "none",
              }}
            >
              ⚡ Generate
        ...
        >
          ...
          >
            ...
            <span>
              Paste existing code to debug, explain, or optimize · or describe
              what to generate
            </span>
          </div>
        </section>
      ...
      >
        ...
        <span>
          Made with <span style={{ color: "rgba(0,212,255,0.4)" }}>❤️</span>
        </span>
        <span style={{ color: "rgba(0,212,255,0.2)" }}>◈</span>
